...
},{"d3-array":"../node_modules/d3-array/src/index.js"}],"../node_modules/d3-sankey/src/constant.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/d3-sankey/src/sankey.js":[function(require,module,exports) {
"use strict";
...
function Sankey() {
  ...
  function computeNodeLayers({
    ...
    const x = (0, _d3Array.max)(nodes, d => d.depth) + 1;
  ...
  function initializeNodeBreadths(columns) {
    const ky = (0, _d3Array.min)(columns, c => (y1 - y0 - (c.length - 1) * py) / (0, _d3Array.sum)(c, value));
  ...
  function computeNodeBreadths(graph) {
    ...
    py = Math.min(dy, (y1 - y0) / ((0, _d3Array.max)(columns, c => c.length) - 1));
...
},{"d3-array":"../node_modules/d3-array/src/index.js","./align.js":"../node_modules/d3-sankey/src/align.js","./constant.js":"../node_modules/d3-sankey/src/constant.js"}],"../node_modules/d3-sankey/src/sankeyLinkHorizontal.js":[function(require,module,exports) {
"use strict";
...
},{"d3-shape":"../node_modules/d3-shape/src/index.js"}],"../node_modules/d3-sankey/src/index.js":[function(require,module,exports) {
"use strict";
...
exports.CreateGraphNodeAndLink = CreateGraphNodeAndLink;
exports.CreateSVGLines = CreateSVGLines;
exports.CreateSVGNodes = CreateSVGNodes;
exports.CreateSVGTextInfo = CreateSVGTextInfo;
  ...
  for (var i = 1; i < keys.length; ++i) {
    ...
    try {
      var _loop = function _loop() {
        var d = _step2.value;
        var names = prefix.map(function (k) {
          return d[k];
        });
        var key = JSON.stringify(names);
        var value = parseInt(d.count) || 1;
...
(function (d3) {
  ...
  d3.csv('./pset_env_route_vit.csv').then(function (data) {
    ...
    function build() {
      var sankey = (0, _d3Sankey.sankey)().nodeSort(null).linkSort(null).nodeWidth(4).nodePadding(20).extent([[0, 5], [graphSize.width, graphSize.height]]);
